...
// Function to preload some available locales
...
if (typeof window !== "undefined") {
  window.addEventListener("load", async function () {
    try {
      // Load default locale and style in parallel
      await Promise.all([loadAllCSLStyles(), loadAllLocalesAsync()]);
      console.log("Default locale and style loaded successfully");
    } catch (error) {
      console.error("Error loading default locale or style:", error);
    }
  });
}
